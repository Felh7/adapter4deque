    ...
    if ((index >= 0) and (index < size)){
        *nop+=2;
        if (index > size / 2){
            ...
            int element;
            *nop+=1;
            for (int i = 0; i <= size - index -1 ; i++) { *nop+= 4;
    ...
    if ((index >= 0) and (index < size)) {
        ...
        *nop+=2;
        if (index > size / 2 ){
            ...
            *nop+=2;
            for (int i = size - index; i < size; i++){ *nop+=2;
                tmpSt1->push_top(deque->pop_top());
                *nop+=2;
            }
            delete(deque);
            class deque* tmpSt2 = new class deque(); *nop+=1;
            tmpSt2->set_nop(nop);*nop+=1;
            *nop+=1;
            for (int i = 0; i < size; i++){*nop+=2;
            ...
            *nop+=2;
            for (int i = index+1; i < size; i++) { *nop+=2;
                tmpSt1->push_down(deque->pop_down());
                *nop+=2;
            }
            delete(deque);
